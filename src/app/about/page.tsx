  ...
  return (
    <div className="min-h-screen bg-[#fdfbf7]">
      ...
      <section className="relative py-20 bg-[#2c1810] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto">
            История нашего семейного кафе, где каждый гость становится частью
            большой семьи.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                Мы открыли двери нашего кафе в 2010 году с простой мечтой:
                создать место, где семьи могли бы собираться вместе,
                наслаждаться вкусной едой и забывать о суете будней.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Начав с небольшого помещения и бабушкиных рецептов, мы выросли в
                любимое место для многих горожан. Но наши ценности остались
                прежними: только свежие продукты, искреннее гостеприимство и
      ...
      <section className="py-16 bg-[#e6d5b8] bg-opacity-30">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold text-center text-[#2c1810] mb-12">
            Наши Ценности
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Мы создаем атмосферу, в которой комфортно и детям, и взрослым. У
                нас есть игровая зона и специальное детское меню.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 bg-[#2c1810] text-white rounded-full flex items-center justify-center mx-auto mb-6 text-2xl">
              ...
              <p className="text-gray-600">
                Используем только натуральные ингредиенты от проверенных
                фермеров. Никаких полуфабрикатов — готовим всё сами.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              <div className="w-16 h-16 bg-[#2c1810] text-white rounded-full flex items-center justify-center mx-auto mb-6 text-2xl">
              ...
              <p className="text-gray-600">
                Каждая деталь интерьера подобрана с любовью, чтобы вы
